...
class Empty a where
  -- some boring, 'empty' element which doesnt contain a lot of information
  empty :: a
...
instance Arbitrary Operation where
  arbitrary = oneof $ [liftM READ positive, liftM WRITE positive,
                      ...
                      [ return x | x <- [ADD,MUL,SUB,DIV,MOD] ] ++
...
-- Commands can be automatically generated by QuickCheck
-- because Counter and Operation have Arbitrary instances
  ...
  arbitrary = sized countergen
    where countergen :: Int -> Gen Counter
          countergen n | n == 0 = return E
                       ...
                       | True   = liftM2 C (choose (1,n)) (countergen (n-1))
